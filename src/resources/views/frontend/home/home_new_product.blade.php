                            ...
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    ...
                                    <div class="product-action-1">
                                        ...
                                        <a arial-label="Compare" class="action-btn" href=""><i
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-10-1.jp') }}g"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-10-2.jp') }}g"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-12-1.jp') }}g"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-12-2.jp') }}g"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-13-1.jp') }}g"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-13-2.jp') }}g"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-14-1.jp') }}g"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-14-2.jp') }}g"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-15-1.jp') }}g"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-15-2.jp') }}g"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-16-1.jp') }}g"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-16-2.jp') }}g"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-11-1.jp') }}g"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/assets/imgs/shop/product-11-2.jp') }}g"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
