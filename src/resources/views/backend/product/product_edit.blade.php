                            ...
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="form-group
                                        ...
                                        <textarea class="form-control" name="short_description" id="inputProductDescription" rows="3">{{ $products->short_descp }}</textarea>
                                    </div>
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <select name="subcategory_id" class="form-select" id="subcategory_id">
                                                ...
                                                @foreach ($subcategory as $subcat)
                                                    <option
                                                        value="{{ $subcat->id }}"{{ $subcat->id == $products->subcategory_id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select name="vendor_id" class="form-select" id="inputCollection">
                                                ...
                                                @foreach ($activeVendor as $vendor)
                                                    <option
                                                        value="{{ $vendor->id }}"{{ $vendor->id == $products->vendor_id ? 'selected' : '' }}>
                                                        {{ $vendor->name }}</option>
                                                @endforeach)
                                            </select>
                                        </div>
