                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="mb-3">
                                    <label for="inputProductSize" class="form-label">Main Thumbnail</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="multi_img[]" class="form-control" id="formFileMultiple"
                                        multiple="">
                                </div>
                            ...
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="pruduct_qty" class="form-control"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="categiry_id" class="form-select" id="inputVendor">
                                            <option></option>
                                            <option value="1">One</option>
                                            <option value="2">Two</option>
                                            <option value="3">Three</option>
                                    ...
                                    <div class="col-12">
                                        <label for="inputCollection" class="form-label">Product SunCategory</label>
                                    ...
                                    <div class="col-12">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" name="special_offer"
                                                        id="flexCheckDefault" value="1">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" name="special_deals"
                                                        id="flexCheckDefault" value="1">
